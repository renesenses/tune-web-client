      ...
      <div class="album-viewport-wrapper">
        ...
        {:else}
          <div style="height:{albumGridMetrics.totalHeight}px;position:relative;">
            <!-- La largeur de colonne CSS doit suivre celle qu'utilise le
                 calcul de virtualisation ci-dessus, sinon les lignes rendues
                 ne tombent pas là où le défilement les attend. -->
            <div class="albums-grid" style="transform:translateY({albumGridMetrics.offsetY}px);--album-col-min:{albumWall ? 88 : 140}px;">
