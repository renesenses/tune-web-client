...
<aside class="sidebar">
  ...
  <nav class="nav-section reglages-section">
    ...
    <div class="reglages-items" class:reglages-open={reglagesOpen}>
      ...
      <button class="nav-item" class:active={$activeView === 'settings' && false} onclick={() => navigateToSettingsTab('clap')}>
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 12h2l2-7 3 14 3-10 2 5 2-2h6" /></svg>
      ...
      <button class="nav-item" class:active={$activeView === 'settings' && false} onclick={() => navigateToSettingsTab('devices')}>
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="4" y="2" width="16" height="20" rx="2"/><circle cx="12" cy="14" r="4"/><line x1="12" y1="6" x2="12.01" y2="6"/></svg>
  ...
  <nav class="nav-section reglages-section">
    ...
    <div class="reglages-items" class:reglages-open={toolsOpen}>
      ...
      <button class="nav-item" class:active={$activeView === 'declick'} onclick={() => navigate('declick')}>
