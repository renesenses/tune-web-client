...
<aside class="sidebar">
  ...
  <nav class="nav-section">
    ...
    <button class="nav-item" class:active={$activeView === 'genres'} onclick={() => navigate('genres')}>
    ...
    <button class="nav-item" class:active={$activeView === 'playlistmanager'} onclick={() => navigate('playlistmanager')}>
