...
import { vueDepuisHash } from './lib/routeAuChargement';
  ...
  import GenreTreeView from './components/v2-heritage/GenreTreeView.svelte';
...
import AlarmsView from './components/AlarmsView.svelte';
  ...
  import PlaylistsHub from './components/v2-heritage/PlaylistsHub.svelte';
  import SmartAIView from './components/v2-heritage/SmartAIView.svelte';
  import AmbianceView from './components/v2-heritage/AmbianceView.svelte';
