export default {
  ...
  'settings.addDevice': 'Ajouter un appareil',
  'settings.addDeviceSubmit': 'Ajouter',
  'settings.deviceType': 'Type',
  'settings.deviceHost': 'IP',
  'settings.devicePort': 'Port',
  'settings.deviceName': 'Nom',
  'settings.deviceNamePlaceholder': 'Optionnel (auto-détecté)',
