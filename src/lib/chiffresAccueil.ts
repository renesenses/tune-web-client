 ...
 * Six cartes par défaut : la ligne dit l'essentiel. Elle n'a plus de plafond
 * depuis #1561 — on en coche autant qu'on veut.
 */
 ...
 *
 * 🔴 #1561 — LA LIGNE N'A PLUS DE PLAFOND. Elle en a eu un de six
 * (`MAXIMUM_CHIFFRES`), d'abord refusé en silence, puis annoncé par un
 * message « ligne pleine » et des cases grisées (#1519, PR #1564). Décision
 * de Bertrand, 25/09/2026 : « Don't put any limit on the widget ! ». On peut
 * cocher TOUT le catalogue ; les cartes passent à la ligne à l'écran.
 *
 * Aucun choix enregistré n'est touché : une ligne de six reste une ligne de
 * six, on peut simplement y en ajouter.
 */
