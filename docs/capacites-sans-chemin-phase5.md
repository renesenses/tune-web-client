...
- `validateLicense` — `POST /cloud/license/validate` — ✅ **porté** : Réglages › Licence (onglet Licence Tune Premium), ligne « Revalider la licence » → « Valider » (`SettingsV2`, `validateLic`, verdict par `verdictValidationLicence`)
